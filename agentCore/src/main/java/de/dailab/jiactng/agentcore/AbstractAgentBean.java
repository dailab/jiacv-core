 ...
 */
public abstract class AbstractAgentBean extends AbstractLifecycle implements IAgentBean {
	...
	/**
	 * Creates an agent bean that may use lifecycle support in strict mode. This means, that the lifecycle graph is
	 * enforced.
	 */
