...
public class CommBean extends AbstractAgentBean implements IEffector {
	...
	// �ber den Communicator l�uft die JMS communication
	...
	// defaultm�ssig wird das BasicProkoll erzeugt
	...
	public void doInit() throws Exception {
		...
		// auf eine Queue mit dem Namen der eigenen Addresse h�ren
		...
		// gesendet wird defaultm�ssig auf die defaultQueue.. (?)
	...
	/**
	 * Erzeugt ein Protokoll f�r den Queue-/Topic-Listener.
	 * 
	 ...
	 * @return entsprechend des Protokolltyps, wird dieses zur�ckgeliefert, sonst ein neues standardprotokoll
	 *         zur�ckgegeben.
	 */
	...
	/**
	 * F�gt einen CommListner der Commbean zu.
	 * 
	 * @param listener
	 */
