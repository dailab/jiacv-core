...
public class JiacMessageFactory {
	...
	public static IJiacMessage createJiacMessage(String op, Object payload) {
		IJiacMessage message = null;
		message = new JiacMessage(op, payload, EndPointFactory.createEndPoint());
		return message;
	}

	public static IJiacMessage createJiacMessage(String op, Object payload, IEndPoint origin, Destination replyToDestination) {
		IJiacMessage message = null;
		message = new JiacMessage(op, payload, EndPointFactory.createEndPoint(), origin, replyToDestination);
		return message;
	}

	public static IJiacMessage createJiacMessage(String op, Object payload, IEndPoint origin, IEndPoint destEndPoint, Destination replyToDestination) {
		IJiacMessage message = null;
