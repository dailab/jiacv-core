...
public class JMSCommunicationBean extends AbstractCommunicationBean {
    ...
    public void doInit() throws Exception {
        ...
        _sender= new JMSSender(getConnectionFactory(), LogFactory.getLog(getClass().getName() + ".JMSSender"));
        _receiver= new JMSReceiver(getConnectionFactory(), new DefaultMessageDelegate(), LogFactory.getLog(getClass().getName() + ".JMSReceiver"));
    }
