...
public class JmxAgentCommunicationManagementClient extends JmxAbstractManagementClient {
	 ...
	 * @see de.dailab.jiactng.agentcore.comm.CommunicationBean#messageExchanged(de.dailab.jiactng.agentcore.management.jmx.MessageExchangeNotification.MessageExchangeAction, de.dailab.jiactng.agentcore.comm.ICommunicationAddress, de.dailab.jiactng.agentcore.comm.message.IJiacMessage, String)
	 */
