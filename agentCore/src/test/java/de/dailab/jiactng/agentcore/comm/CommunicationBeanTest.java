...
public class CommunicationBeanTest extends JIACTestForJUnit3 {
	...
	public void testRegisterAndUnRegister() throws Exception{
		...
		listenerCountForAddress1SelectorNull = 0;
        ...
        // quick test the order given
        assertEquals("One Order given", 1, _registration.orders.size());
        order = _registration.orders.get(0);
