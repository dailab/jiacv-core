 ...
 * 
 */
public class SessionNonBlockUnitTest extends TestCase {

  private final static String CONFIG_PATH      = "de/dailab/jiactng/agentcore/execution/SessionTestNonBlock.xml";
