...
public class JmxAgentNodeTimerManagementClient extends
	 ...
	 */
	public final void addTimerNotificationListener(NotificationListener listener) throws IOException, InstanceNotFoundException {
	 ...
	 */
	public final void removeTimerNotificationListener(NotificationListener listener) throws IOException, InstanceNotFoundException, ListenerNotFoundException {
	 ...
	 */
	public final Integer addNotification(String type, String message, Object userDate, Date date) throws IOException, InstanceNotFoundException {
	 ...
	 */
	public final void removeNotification(Integer id) throws IOException, InstanceNotFoundException {
	 ...
	 */
	public final Date getDate(Integer id) throws IOException, InstanceNotFoundException {
