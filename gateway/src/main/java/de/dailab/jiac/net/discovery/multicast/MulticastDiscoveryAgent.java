...
public class MulticastDiscoveryAgent implements DiscoveryAgent,Runnable{
    ...
    public void setLoopBackMode(boolean loopBackMode){
        this._loopBackMode=loopBackMode;
    }
    ...
    public void setDiscoveryURI(URI discoveryURI){
        this._discoveryURI=discoveryURI;
    }
    ...
    public void start() throws Exception{
        if(_started.compareAndSet(false,true)){
            ...
            this._inetAddress=InetAddress.getByName(_discoveryURI.getHost());
            this._sockAddress=new InetSocketAddress(this._inetAddress,_discoveryURI.getPort());
    ...
    private void processData(String str){
        ...
        if(str.startsWith(getType())){
            ...
            if(payload.startsWith(ALIVE)){
                ...
                if(!brokerName.equals(this._brokerName)){
